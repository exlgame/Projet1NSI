import pygame
from pygame.examples.scrap_clipboard import width, height
...
class Entity(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.image = self.all_images[self.direction][self.index_images]
    ...
    def animation_sprite(self):
        ...
        self.index_images = int(self.step//8) + self.image_part
